...
public class SubAWCM_Processor {
    ...
    public List<SubAwardComponent> process(R2507AW_R2508AWCM awcm, Problems awProbs) {
    ...
    private void loadSubAwardComponent(SpSubAwardComponent sac,
        ...
        val inc = PscsUtils.intData(data, 12, 2);
        if(inc > 0) sac.getRate().setIncrementRate(inc);
